        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ideas.map((idea) => (
                ...
                >
                    ...
                    <p className="text-sm text-neutral-400 leading-relaxed text-justify opacity-90 break-words mb-6 line-clamp-3">
                        {idea.description}
                    </p>
                    ...
                    <div className="flex justify-between items-center mt-auto pt-4 border-t border-neutral-800/50">
                        ...
                        <div className="flex items-center gap-1 text-red-500/60 font-bold text-[10px] uppercase tracking-tighter group-hover:text-red-400 transition-colors">
                            <span>АНАЛИЗ</span>
